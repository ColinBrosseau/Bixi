...
Original code from svn.pyyaml.org/pyyaml-legacy/trunk/experimental/XmlYaml/convertyaml_map.py
2017/05/31
    Added convertXml2dict function
    Colin-N. Brosseau
...
#
# Convert an XML document (file) to a dict and return it
#

def convertXml2dict(inFileName):
    doc = minidom.parse(inFileName)
    root = doc.childNodes[0]
    # Convert the DOM tree into "YAML-able" data structures.
    return convertXml2YamlAux(root)
